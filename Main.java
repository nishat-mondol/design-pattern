...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (select == 1) {
            ...
            Student admissionStudent1 = new Student("'Md.Nishat Mondol", newAdmission1);
            ...
            Teacher t1 = new Teacher("Mr. Md. Mushfiqur Rahman,", 569871444, "Lecturer", "Software Engineering");
            t1.show();
            Teacher t2 = new Teacher("Mr.karim", 542361444, "Lecturer", "Software Engineering");
            t2.show();
        } else if (select == 3) {
            Advisor adv1 = new Advisor("Mr. Md Fahad Bin Zamal",851471739, "fahad.swe@diu.edu.bd", 01714410672);
            adv1.show();
        } else if (select == 4) {
